                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li>CVC: any of three digits</li>
                                <li>Expiration: any day in the future</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <label>Card Expiration Day:</label>
                                <input type="text"
                                       class="form-control"
                                       placeholder="MM/YY"
                                       v-model="card.exp"
...
export default {
    data () {
        return {
            ...
            errors: [],
            stripePublishableKey: 'pk_test_XucYhyRVtMAjV7olPAvMH2zv00d1tPQVS0',
            stripeCheck: false,
        };
    },
    methods: {
